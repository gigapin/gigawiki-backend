...
{
  #[Id]
  #[Column(type: Types::INTEGER, options: ['unsigned' => true]), GeneratedValue]
  private int $id;

  #[Column(name: 'user_id')]
  private int $userId;

  #[Column(name: 'subject_id',type: Types::INTEGER, options: ['unsigned' => true])]
  ...
  #[Column(name: 'image_id',type: Types::INTEGER, options: ['unsigned' => true])]
  private int $imageId;
